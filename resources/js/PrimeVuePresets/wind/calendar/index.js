export default {
    ...
    tablebodyrow: {
        class: ['border-b border-surface-500/40  last:border-b-0'],
    },
    weekheader: {
        class: [
    ...
    weeknumber: {
        class: [
            'text-slate-600 dark:text-surface-50 font-normal',
            'opacity-40 cursor-default',
        ],
    },
    weekday: {
        class: [
            // Colors
            'text-slate-500 dark:text-surface-50 font-normal',
        ],
    },
    day: {
        class: [
    ...
    daylabel: ({ context }) => ({
        class: [
            ...
            // Colors
            {
                'text-slate-50 bg-slate-900 dark:text-surface-900 dark:bg-surface-50':
                    context.date.today &&
                    !context.selected &&
                    !context.disabled,
                'text-slate-600 dark:text-surface-50 bg-transparent':
                ...
                'text-primary-500 dark:text-primary-400':
                    ...
                    !context.disabled &&
                    !context.date.today,
                'text-primary-200 dark:text-primary-600 bg-slate-900 dark:bg-surface-50':
                    context.selected &&
                    !context.disabled &&
                    context.date.today,
            },

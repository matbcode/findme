export default {
    ...
    container: ({ props, state }) => ({
        class: [
            ...
            'px-3 py-1',
            {
                'px-3 py-1.5': !props.multiple,
                'px-3 py-1': props.multiple,
            },
            // Size
            'w-full',
    ...
    inputtoken: ({ props }) => ({
        class: [
            {
                'py-1.5 px-0': !props.multiple,
                'p-0.5': props.multiple,
            },
            ,
    ...
    input: ({ props }) => ({
        class: [
            ...
            // Colors
            {
                ...
                'text-slate-700 dark:text-surface-50': props.multiple,
    ...
    loadingicon: {
        class: [
            'text-sm leading-none text-slate-500 dark:text-surface-50/70',

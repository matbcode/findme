export default {
    root: ({ props, context }) => ({
        class: [
            ...
            {
                'shadow-sm':
                    !props.raised && !props.link && !props.text,
            ...
            {
                'text-slate-500 ring-1 ring-gray-500':
            ...
            {
                'text-slate-500 ring-1 ring-surface-500 hover:bg-slate-300/20':
                    props.outlined &&
                    props.severity === 'secondary' &&
                    !props.plain,
            },
            ...
            // Secondary
            {
                'hover:bg-slate-600 dark:hover:bg-slate-300 hover:ring-surface-600 dark:hover:ring-surface-300':
                    props.severity === 'secondary' &&
                    !props.text &&
                    !props.outlined &&
                    !props.plain,

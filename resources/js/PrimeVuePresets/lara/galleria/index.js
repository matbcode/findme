export default {
    ...
    indicatorbutton: ({ context }) => ({
        class: [
            ...
            {
                'bg-surface-200 hover:bg-surface-300 dark:bg-surface-800 dark:hover:bg-surface-600':
                    !context.highlighted,
            },
    ...
    previousitembutton: ({ parent }) => ({
        class: [
            ...
            // Appearance
            'bg-transparent text-white w-16 h-16 transition duration-200 ease-in-out rounded-2xl',
            {

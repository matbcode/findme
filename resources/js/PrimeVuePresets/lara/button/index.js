export default {
    root: ({ props, context, parent }) => ({
        class: [
            ...
            'font-medium',
            'border-0',
            'hover:saturate-120 hover:shadow-lg',
            ...
            // Plain Button
            {
                'text-slate-600 bg-slate-100 dark:bg-surface-800 border border-surface-500/40  dark:text-surface-50':
                    props.plain && !props.outlined && !props.text,
            },
            // Plain Text Button
            { 'text-slate-500': props.plain && props.text },
            // Plain Outlined Button
            {
                'text-slate-500 border border-surface-500/40 bg-white':
            ...
            {
                'text-slate-500 dark:text-surface-50 border border-surface-500/40 hover:bg-slate-300/20':
                    props.outlined &&
                    props.severity === 'secondary' &&
                    !props.plain,
            },
            ...
            // Plain
            {
                'hover:bg-surface-200 dark:hover:bg-slate-700':
                    props.plain && !props.outlined && !props.text,
            },
            ...
            // Secondary
            {
                'hover:bg-indigo-600 dark:hover:bg-indigo-800 hover:border-surface-500/40 dark:hover:border-surface-500/40':
                    props.severity === 'secondary' &&
                    !props.text &&
                    !props.outlined &&
                    !props.plain,
            ...
            // Disabled
            {
                'grayscale opacity-50 pointer-events-none cursor-default':
                    context.disabled,
            },

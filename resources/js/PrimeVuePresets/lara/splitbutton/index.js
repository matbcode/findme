        ...
        root: ({ parent }) => ({
            class: [
                ...
                // Sizes & Spacing
                {
                    ...
                    'text-sm py-2 px-3':
                        parent.props.size === 'small',
                    'text-xl py-3 px-4':
                        parent.props.size === 'large',
                },
                {
                ...
                {
                    'rounded-2xl': !parent.props.rounded,
                ...
                {
                    'text-slate-500':
                        parent.props.plain && parent.props.text,
                },
                // Plain Outlined Button
                {
                    'text-slate-500 border border-gray-500':
                ...
                // Secondary Button
                {
                    'text-white dark:text-surface-900':
                        ...
                        !parent.props.outlined &&
                        !parent.props.plain,
                    'bg-slate-500 dark:bg-surface-400':
                        parent.props.severity === 'secondary' &&
                        !parent.props.text &&
                        !parent.props.outlined &&
                        !parent.props.plain,
                ...
                {
                    'text-slate-500 border border-surface-500/40 hover:bg-slate-300/20':
                        parent.props.outlined &&
                        parent.props.severity === 'secondary' &&
                        !parent.props.plain,
                },
                ...
                // Secondary
                {
                    'hover:bg-slate-600 dark:hover:bg-slate-300 hover:border-surface-500/40 dark:hover:border-surface-500/40':
                        parent.props.severity === 'secondary' &&
                        !parent.props.text &&
                        !parent.props.outlined &&
                        !parent.props.plain,

...
const platform = ref(platforms.value.find((p) => p.key === 'discord'))
</script>
...
<template>
    ...
    >
        <p class="px-4 text-surface-200">
            This Discord account was connected to your profile, you
            will be able to assign it to projects and schedule posts
            using it. You can also use it to collect data from Discord
        ...
        >
            ...
            >
                <li>
                    In Discord: Go to your Discord settings and
                    ...
                    managing connected apps in Discord, you can visit
                    the
                    <a
                        class="font-semibold text-primary-400"
                        href="https://help.discord.com/en"
                        >Help Center</a
                    >
                </li>
                <li>

...
const platform = ref(
    platforms.value.find((p) => p.key === 'linkedin'),
)
</script>
...
<template>
    ...
    >
        <p class="px-4 text-surface-200">
            This Linkedin account was connected to your profile, you
            will be able to assign it to projects and schedule posts
            using it. You can also use it to collect data from
            Linkedin and connect it when generating reports.
        </p>
        <div
        ...
        >
            ...
            >
                <li>
                    In Linkedin: Go to your Linkedin settings and
                    ...
                    managing connected apps in Linkedin, you can visit
                    the
                    <a
                        class="font-semibold text-primary-400"
                        href="https://help.linkedin.com/en"
                        >Help Center</a
                    >
                </li>
                <li>

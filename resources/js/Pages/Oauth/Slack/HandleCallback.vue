...
const platform = ref(platforms.value.find((p) => p.key === 'slack'))
</script>
...
<template>
    ...
    >
        <p class="px-4 text-surface-200">
            This Slack account was connected to your profile, you will
            be able to connect in to workspace and receive
        ...
        >
            ...
            >
                <li>
                    In Slack: Go to your Slack settings and navigate
                    to the "Security and privacy" section. Then, under
                    "Apps and devices," you can find and disconnect
                    Raichi. For more information on managing connected
                    apps in Slack, you can visit the
                    <a
                        class="font-semibold text-primary-400"
                        href="https://help.slack.com/en"
                        >Help Center</a
                    >
                </li>
                <li>
